...
class ExecutionClient:
    ...
    def get_account(self) -> AccountSnapshot:
        ...
        try:
            ...
            raise ExecutionClientError(f"Invalid account response: {exc}", body=data) from exc
    ...
    def get_positions(self) -> list[Position]:
        ...
        try:
            ...
            raise ExecutionClientError(f"Invalid positions response: {exc}", body=data) from exc
    ...
    def get_orders(self, status: str | None = None) -> list[OrderResponse]:
        ...
        try:
            ...
            raise ExecutionClientError(f"Invalid orders response: {exc}", body=data) from exc
    ...
    def submit_order(self, intent: OrderIntent) -> OrderResponse:
        ...
        try:
            ...
            raise ExecutionClientError(f"Invalid order response: {exc}", body=data) from exc
    ...
    def cancel_order(self, order_id: str) -> OrderResponse:
        ...
        try:
            ...
            raise ExecutionClientError(f"Invalid cancel response: {exc}", body=data) from exc
