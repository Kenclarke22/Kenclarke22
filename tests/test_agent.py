...
def test_risk_matches_positions_with_mixed_case_symbols(tmp_path):
    settings = Settings(
...
def test_rebalance_uses_mixed_case_existing_position():
    ...
    ctx = StrategyContext(
        ...
        metadata={"target_weights": {"AAPL": 0.1}, "rebalance_threshold": 0.001},
    )
